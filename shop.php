...
<body>
  ...
  <section class="products">
    ...
    <div class="category-buttons">
      ...
      <a href="shop.php?category=romance" class="category-btn <?php echo $category_filter == 'romance' ? 'active' : ''; ?>">Romance</a>
      <a href="shop.php?category=action" class="category-btn <?php echo $category_filter == 'action' ? 'active' : ''; ?>">Action</a>
      <a href="shop.php?category=drama" class="category-btn <?php echo $category_filter == 'drama' ? 'active' : ''; ?>">Drama</a>
      <a href="shop.php?category=sci-fi" class="category-btn <?php echo $category_filter == 'sci-fi' ? 'active' : ''; ?>">Sci-Fi</a>
      <a href="shop.php?category=comedy" class="category-btn <?php echo $category_filter == 'comedy' ? 'active' : ''; ?>">Comedy</a>
      <a href="shop.php?category=horror" class="category-btn <?php echo $category_filter == 'horror' ? 'active' : ''; ?>">Horror</a>
      <a href="shop.php?category=thriller" class="category-btn <?php echo $category_filter == 'thriller' ? 'active' : ''; ?>">Thriller</a>
      <a href="shop.php?category=education" class="category-btn <?php echo $category_filter == 'education' ? 'active' : ''; ?>">Education</a>
    </div>
